...
\title{
    ...
    Students:\\Panagiotis Giannikos, IPPS Data Science and Machine Learning \par
    Markos Syroukis, IPPS Mathematical Modeling \par \vspace{0.5cm}}
...
\paragraph{Encoders.}
An \texttt{ImageTextEncoder} protocol has three
...
directly to caption-grounded relevance,
...
the masks make the change-heatmap
...
save/load), the encoder protocol/registry, and the app's query path
...
makes this concrete: on the best test
...
\texttt{PairLabel.stable} flag) yields a false-positive-rate
curve. Table~\ref{tab:seasonalgate} reports the curve
...
\url{https://github.com/Panagiotis427/msc-gbda-ov-temporal-change-retrieval}. The
